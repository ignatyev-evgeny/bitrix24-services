    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __('Новая группа сотрудников') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('home', ['auth_id' => $auth->auth_id]) }}">{{ __('Главная') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('Новая группа пользователей') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form method="POST" id="newUserGroupForm" multiple="">
                            ...
                            <div class="card card-info">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="groupDescription" class="w-100"></textarea>
                                            </div>
                                            <div class="form-group">
                                ...
                                <div class="card-footer">
                                    <button type="button" class="btn btn-success w-100 btnSave">{{ __('Создать группу сотрудников') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btnSave').click(function() {
                ...
                var request = $.ajax({
                    url: "{{ route('users.groups.store', ['auth_id' => $auth->auth_id]) }}",
                    type: 'POST',
                    dataType: 'JSON',
                    data: $('form#newUserGroupForm').serialize(),
                })
                request.done(function( data ) {
                    $('.btnSave').text(data.message);
